window.onload = function()
{
    ...
    */
    ...
    var puntoDeVista = function()
	{
        ...
        /*
        if(frustum.intersectsObject(cube))//pasar el planeta
        {
            if(!veCubo)
            {
                veCubo = true;
                responsiveVoice.speak("Estas viendo un cubo, es temporal, por favor borrarlo al final", "Spanish Female");
            }
        }
        else
        {
        ...
        */
        for(var i=0; i < planetas.length; i++)
        {
            ...
            if(frustum.intersectsObject(planetas[i].objeto))//pasar el planeta
            {
                if(!planetas[i].vista)
                {
                    planetas[i].vista = true;
                    console.log("Estas viendo el planeta:"+planetas[i].nombre);
                }
            }
            else
            {
